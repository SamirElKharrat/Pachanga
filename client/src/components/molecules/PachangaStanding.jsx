                    ...
                    <div>
                        <h4>
                            <span style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                                <BookOutlined style={{ color: 'var(--accent-light)' }} /> Normativa de la Pachanga {selectedYear}
                            </span>
                            {rulesList.length > 0 && (
                                <span style={{ fontSize: 11, color: 'var(--text-dim-2)', fontWeight: 600 }}>
            ...
            <Modal
                title={
                    <div style={{ padding: '6px 0 4px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', paddingRight: 32 }}>
                        <Title level={4} style={{ margin: 0, color: 'var(--text-strong)', display: 'flex', alignItems: 'center', gap: 8 }}>
                            <BookOutlined style={{ color: 'var(--accent-light)' }} /> Normativa Oficial — Pachanga {selectedYear}
                        </Title>
                        {isAdmin && (
                            <Button
                                type="primary"
