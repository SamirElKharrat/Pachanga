        ...
        <div style={{ padding: '24px', maxWidth: 1200, margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: 48 }}>
                ...
                <Paragraph type="secondary" style={{ fontSize: 14, marginTop: 8 }}>
                    Reconocimiento histórico a los campeones de la Pachanga.
                </Paragraph>
            </div>
                    ...
                    {players.map((player) => (
                        <Col key={player.id} xs={24} sm={12} md={8} lg={6}>
                            ...
                            >
                                ...
                                <div style={{ flex: 1 }}>
                                    <Space align="start" size={4} style={{ marginBottom: 4 }}>
                                        <GlobalOutlined style={{ fontSize: 10, marginTop: 3, opacity: 0.5 }} />
            ...
            <Row gutter={[12, 12]}>
                {players.map((player, index) => (
                    <Col key={player.id} xs={24} sm={12} md={8}>
                        ...
                        >
                            <Text strong style={{ fontSize: 14, width: 24, opacity: 0.3 }}>#{index + 1}</Text>
